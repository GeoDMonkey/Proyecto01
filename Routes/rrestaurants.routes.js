...
const {createRestaurantsValidato, createReviewsValidator} = require('../Middleware/validator.middleware');
...
restaurantsRouetes.post('/reviews/:restaurantId',reviewsExists, createReviewsValidator, postReviewsRestaurantId)
